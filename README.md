...
1. Download the [Miside Super Wallpaper APK](https://github.com/minhmc2007/Miside-Super-Wallpaper/releases/tag/V1.0.0-final)
2. Decompile using APKTool: (or just download the wallpaper.zip)
```bash
